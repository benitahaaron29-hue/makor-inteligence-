/**
 * Makor Intelligence Platform — Tailwind theme (Next.js v0.1)
 * Bound to CSS design tokens in styles/tokens.css.
 */
...
const config: Config = {
  ...
  theme: {
    colors: {
      ...
      makor: {
        50:  "var(--makor-50)",  100: "var(--makor-100)", 200: "var(--makor-200)",
        300: "var(--makor-300)", 400: "var(--makor-400)", 500: "var(--makor-500)",
        600: "var(--makor-600)", 700: "var(--makor-700)", 800: "var(--makor-800)",
        900: "var(--makor-900)", 950: "var(--makor-950)",
      },
      brass: { DEFAULT: "var(--accent-brass)", soft: "var(--accent-brass-soft)" },

      bid: "var(--bid)", "bid-soft": "var(--bid-soft)",
      offer: "var(--offer)", "offer-soft": "var(--offer-soft)",
      neutral: "var(--neutral)",
      warning: "var(--warning)", "warning-soft": "var(--warning-soft)",
      info: "var(--info)", alert: "var(--alert)",
      "risk-on":      "var(--risk-on)",
    ...
    spacing: {
      ...
      11: "44px", 12: "48px", 14: "56px", 16: "64px", 20: "80px", 24: "96px", 32: "128px",
    ...
    borderRadius: { none: "0", xs: "1px", sm: "2px", md: "3px", lg: "4px", pill: "999px" },
    borderWidth: { 0: "0", DEFAULT: "1px", 1: "1px", 2: "2px" },
    boxShadow: { none: "none", overlay: "var(--elevation-overlay)", popover: "var(--elevation-popover)" },
    extend: {
      transitionDuration: { instant: "0ms", fast: "80ms", medium: "160ms", tick: "400ms" },
      transitionTimingFunction: { linear: "linear", "out-soft": "cubic-bezier(0.22, 1, 0.36, 1)" },
      ringWidth: { DEFAULT: "2px" },
      ringColor: { DEFAULT: "var(--border-focus)" },
      ringOffsetWidth: { DEFAULT: "0" },
      letterSpacing: { eyebrow: "0.10em" },
      maxWidth: { research: "var(--layout-research-max-w)" },
      keyframes: {
        "live-pulse": {
      ...
      animation: { "live-pulse": "live-pulse 1.6s linear infinite" },
    },
  },
  plugins: [],
};
